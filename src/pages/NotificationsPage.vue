...
import { relativeTime } from '../utils/formatters.ts'
import type { Notification } from '../api/notificationsApi.ts'
...
<style scoped>
.notif-page { display: flex; flex-direction: column; gap: 1.25rem; }
...
.select {
  ...
  background: #fff; color: #2C1208; cursor: pointer; outline: none;
}

.btn-mark-all {
  padding: 0.5rem 0.9rem;
  border: 1.5px solid #E0D3C0; background: #fff;
  border-radius: 0.75rem; font-size: 0.8rem; font-weight: 600;
  color: #7B3A18; cursor: pointer; font-family: 'Outfit', sans-serif;
  transition: all 0.2s; white-space: nowrap;
}
.btn-mark-all:hover:not(:disabled) { border-color: #A0522D; }
.btn-mark-all:disabled { opacity: 0.5; cursor: not-allowed; }

.btn-settings {
  padding: 0.5rem 0.9rem;
  background: #F5EDE0; border: 1.5px solid #E0D3C0;
  border-radius: 0.75rem; font-size: 0.8rem; font-weight: 600;
  color: #7B3A18; text-decoration: none; white-space: nowrap;
  transition: all 0.2s; font-family: 'Outfit', sans-serif;
}
.btn-settings:hover { border-color: #A0522D; }

.empty-state { text-align: center; padding: 3rem 1rem; display: flex; flex-direction: column; align-items: center; gap: 0.4rem; color: #A0522D; }
...
.notif-item {
  ...
  background: #fff; border-radius: 1rem; padding: 0.9rem 1rem;
  box-shadow: 0 1px 6px rgba(44,18,8,0.05);
  cursor: pointer; transition: box-shadow 0.2s;
  position: relative;
}
.notif-item:hover { box-shadow: 0 3px 12px rgba(44,18,8,0.1); }
.notif-item.unread { background: #FFF8F0; border-left: 3px solid #A0522D; }
...
.notif-title { font-weight: 600; font-size: 0.875rem; color: #2C1208; }
.notif-msg { font-size: 0.82rem; color: #7B3A18; margin-top: 0.15rem; line-height: 1.4; }
.notif-time { font-size: 0.72rem; color: #C4875A; margin-top: 0.25rem; }

.btn-delete {
  background: none; border: none; cursor: pointer;
  color: #C4875A; padding: 0.2rem; border-radius: 0.35rem;
  opacity: 0; transition: opacity 0.2s, color 0.2s;
  flex-shrink: 0;
}
.notif-item:hover .btn-delete { opacity: 1; }
