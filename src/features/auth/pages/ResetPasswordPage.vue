  ...
  <div class="auth-page">
    <div class="auth-card">
      ...
      <div v-if="success" class="text-center">
        ...
        <RouterLink to="/login" class="btn-submit" style="text-decoration:none; margin-top:1.5rem;">Sign in now
        </RouterLink>
      </div>
        ...
        <form @submit.prevent="submit" class="auth-form">
          <div class="field">
            ...
            <input v-model="newPassword" type="password" required minlength="8" autocomplete="new-password"
                   placeholder="••••••••" :class="{ error: errors.newPassword }"/>
          ...
          <div class="field">
            ...
            <p v-if="passwordMismatch || errors.confirmPassword" class="field-error">
              {{ errors.confirmPassword || 'Passwords do not match' }}</p>
          </div>
